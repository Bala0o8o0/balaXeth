  ...
  return (
    <footer className="relative w-full pt-20 pb-8 px-6 md:px-12 lg:px-20 bg-[#000000] border-t border-[#ffd400]/10 overflow-hidden font-mono selection:bg-[#ffd400]/30 selection:text-[#ffd400]">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full flex justify-center pointer-events-none opacity-[0.02] select-none overflow-hidden">
        <span
          className="text-[20vw] font-black leading-none whitespace-nowrap"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <h2
                  className="text-4xl font-black text-white tracking-[0.2em] uppercase leading-none"
                  style={{ fontFamily: "var(--font-orbitron)" }}
                >
                  BALA
                </h2>
            ...
            <p className="hidden md:block text-white/40 text-[11px] leading-relaxed tracking-widest max-w-sm uppercase">
              Deploying high-performance digital architectures. Available for
              high-priority technical operations and freelance contracts.
            </p>

            {/* Interactive "Email / Newsletter" box typical of premium sites */}
            <form
              onSubmit={handleTransmission}
              className="flex flex-col gap-3 mt-2 relative"
            >
              {/* <span className="text-[9px] text-[#ffd400]/60 tracking-[0.3em] uppercase font-bold">
                Initiate
              </span> */}
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-4 md:gap-6 col-span-2 md:col-span-1">
              <h3 className="text-[10px] font-bold text-[#ffd400] tracking-[0.3em] uppercase border-b border-[#ffd400]/20 pb-2">
                Network
              </h3>
              <ul className="flex flex-row md:flex-col flex-wrap gap-6 md:gap-4">
                {[
                  { name: "GitHub", icon: Github, url: "https://github.com/Bala0o8o0" },
                  { name: "LinkedIn", icon: Linkedin, url: "https://www.linkedin.com/in/bala-murugan-a3ba20240/" },
                  { name: "Twitter", icon: Twitter, url: "https://x.com/balaXeth" },
                ].map((social) => (
                  <li key={social.name}>
                    <a
                      href={social.url}
                      ...
                      className="group flex items-center gap-2 md:gap-3 text-[11px] text-white/50 hover:text-white transition-colors tracking-widest uppercase"
                    >
                      <social.icon
                        size={12}
                        className="text-[#ffd400]/50 group-hover:text-[#ffd400] transition-colors"
                      />
                      {social.name}
                      <ArrowUpRight
                        size={10}
                        className="opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all text-[#ffd400]"
                      />
                    </a>
                  </li>
                ))}
              ...
              <ul className="flex flex-row sm:flex-col gap-10 sm:gap-6">
                <li className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-[#ffd400]/10 border border-[#ffd400]/20 w-fit">
                    ...
                    <span className="text-[9px] text-[#ffd400] font-bold tracking-[0.2em] leading-none">
                      ONLINE
                    </span>
                  </div>
                </li>
      ...
      <AnimatePresence>
        {status === "success" && (
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              <CheckCircle2
                size={24}
                className="text-[#ffd400] relative z-10"
              />
            </div>
            <div className="flex flex-col">
              <span className="text-[12px] font-bold text-[#ffd400] tracking-[0.2em] uppercase">
                Transmission Sent
              </span>
              <span className="text-[10px] text-white/60 tracking-widest uppercase mt-1">
                Comm-link established. Protocol engaged.
              </span>
            </div>
          </motion.div>
        )}
        {status === "error" && (
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-[12px] font-bold text-orange-500 tracking-[0.2em] uppercase">
                Transmission Failed
              </span>
              <span className="text-[10px] text-white/60 tracking-widest uppercase mt-1">
                Interference detected. Try again later.
              </span>
            </div>
          </motion.div>
        )}
