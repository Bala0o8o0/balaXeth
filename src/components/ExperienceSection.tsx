                        ...
                        {EXPERIENCE_DATA.map((item, i) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute left-0 md:left-1/2 transform -translate-x-[5px] md:-translate-x-1/2 mt-1.5 md:mt-0 w-3 h-3 bg-[#000000] border-2 border-[#FF0000] rounded-full z-20 group-hover:scale-150 group-hover:bg-[#FF0000] group-hover:drop-shadow-[0_0_10px_rgba(255,0,0,1)] transition-all duration-300" />
